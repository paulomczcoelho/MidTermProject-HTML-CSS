...
function ready() {
    ...
    const addToCartButtons = document.getElementsByClassName("buy-shoes")
...
function closeCart(){
    let xCart = document.querySelector('.normal-section')
...
function addProductToCart(event) {
    ...
    const productName = productInfos.getElementsByClassName("model-shoes")[0].innerText
    const productPrice = productInfos.getElementsByClassName("price")[0].innerText
    const productsCartNames = document.getElementsByClassName("cart-product-title")
    let demoId = document.querySelector('.normal-section').style.display = "block";
    demoId = document.querySelector('.normal-section').style.position = "fixed";   
